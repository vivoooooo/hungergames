...
User.destroy_all
u1 = User.create(name: "Cheer Bear", email: "cheer@bear.com", password: "chicken", number_of_kills: "1", is_alive: true)
u2 = User.create(name: "Sleepy Bear", email: "sleepy@bear.com", password: "chicken", number_of_kills: "0", is_alive: true)
u3 = User.create(name: "Tenderheart Bear", email: "tenderheart@bear.com", password: "chicken", number_of_kills: "0", is_alive: true)
u4 = User.create(name: "Lucky Bear", email: "lucky@bear.com", password: "chicken",  number_of_kills: "0", is_alive: false)
u5 = User.create(name: "Angry Bear", email: "angry@bear.com", password: "chicken", number_of_kills: "0", is_alive: false)
